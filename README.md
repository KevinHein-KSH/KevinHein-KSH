...
- 🧩 **Backend** — Java (Quarkus, Spring Boot) microservices, ASP.NET Core REST APIs, multi-tenant state schemas
...
| | Role | Stack |
|---|---|---|
| **2024 – 2025** · 🇳🇱 | Backend Developer, **Phinion** *(remote)* | Quarkus microservices, MS Graph + Twilio + SMTP, PostgreSQL CTEs |
...
|---|---|---|
| [**Carrier-Integration-Service**](https://github.com/KevinHein-KSH/Carrier-Integration-Service) | Carrier integration layer | TypeScript |
